...
TableModel::~TableModel()
{
    ...
    ImportertToHtml html;
    html.openFile("new.html");
    html.createTable("Output table data", header_,outPutData);
    html.closeFile();
    delete entity_;
}
...
{
    Q_UNUSED(parent)
    return static_cast<int>(Entity::dispArguments::sizeArguments);
}
